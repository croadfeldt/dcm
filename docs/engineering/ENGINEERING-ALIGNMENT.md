...
- 🔴 **Meta Provider contract compliance** — architecture's Meta Provider model (doc 30) requires: composition declaration at registration, dependency graph between sub-resources, cascading lifecycle management, aggregated status reporting.
